...
use crate::{PRICE_FEED_DECIMAL_ADJUSTMENT, Collateral, Config, CustomError, FEED_ID, MAXIMUM_AGE};

// TODO: check calculated health factor to see if account is health
