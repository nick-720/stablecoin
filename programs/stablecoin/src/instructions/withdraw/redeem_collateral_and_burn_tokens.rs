...
use crate::{Config, SEED_CONFIG_ACCOUNT, SEED_COLLATERAL_ACCOUNT, Collateral, check_health_factor, burn_tokens, withdraw_sol};
...
pub fn process_redeem_collateral_and_burn_tokens(
    ctx: Context<RedeemCollateralAndBurnTokens>, amount_collateral: u64, amount_to_burn: u64) -> Result<()> {
